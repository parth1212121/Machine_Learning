...
def compute_information_gain(X, y, node_indices, feature):
    ...
    h_total=w_left*(h_left)+(w_right)*(h_right)
    
    
    information_gain=h_node-h_total
...
def get_best_split(X, y, node_indices):   
    ...
    for i in range(num_features):
        ...
        if compute_information_gain(X,y,node_indices,i)>inf_gain:
            inf_gain=compute_information_gain(X,y,node_indices,i)
            best_feature=i
